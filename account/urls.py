...
urlpatterns = [
    ...
    path('success_registration/', LogoutView.as_view(), name='logout'),
    path('change_password/', views.ChangePasswordView.as_view(), name='change-password'),
    path('forgot_pass_complete/', TemplateView.as_view(template_name='account/forgot_pass_complete.html'), name='forgot-pass-complete')
]